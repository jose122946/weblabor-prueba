...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        @endif
        <p class="mt-2 text-sm text-center text-gray-600 leading-5 max-w">
        <a href="/public-projects" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">Visualiza los proyectos activos</a>
        </p>
    </div>
